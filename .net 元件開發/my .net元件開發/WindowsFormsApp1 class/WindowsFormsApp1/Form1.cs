    ...
    public partial class Form1 : Form
    {
        ...
        private void btn列出所有員工_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 員工基本資料集合.Count; i += 1)
            {
                ...
                strInfo += string.Format(" {0} {1}公分 {2:F}公斤 {3:C}元 {4:D} 年資:{5:F} 年 獎金:{6:F} 年齡:{7}歲 Email:{8}\n", myperson.姓名, myperson.身高, myperson.體重, myperson.薪資, myperson.到職日, myperson.計算年資(), myperson.依年資計算獎金(1000), myperson.年齡.data, myperson.Email.data);
            }
