...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            Person.aboutInfo(); //靜態方法，不需要new配置記憶體，直接執行
        ...
        {
            Person 員工1 = new Person(170.0f,70.0, Convert.ToDateTime("2022-4-28"), (int)MyEnums.Dep.行政處);
            ...
            員工1.年齡.saveData(30);
            員工1.地址 = new AddressInfo("高雄", "前金區", "中正路8888號");
        ...
        private void btn列出所有員工_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 員工基本資料集合.Count; i += 1) 
            {
                ...
                strInfo += string.Format("{0} 身高:{1:F}公分 體重:{2:F}公斤 薪資:{3:C}元 到職日:{4:D} 年資:{5:F}年 獎金:{6:0}元\n",myPerson.姓名,myPerson.身高,myPerson.體重,myPerson.薪資,myPerson.到職日,myPerson.計算年資(),myPerson.依年資計算獎金(10000.0));
